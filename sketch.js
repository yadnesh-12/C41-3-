...
var chasingCatImg, scaredMouseImg;
...
function preload(){
  ...
  chasingCatImg = loadImage("chasing2.png");
  scaredMouseImg= loadImage("jerryscared.png");
}
...
function draw(){
 ...
 // box2.shapeColor = color(random(255),random(255),random(255));
   box1.changeImage(chasingCatImg)
   box2.destroy();
...
// collision Algorithm of 2 boxes and everytime colour changes randomnly on collision
  if(object1.x-object2.x<object1.width/2+object2.width/2){
    object1.changeImage(box111_img);
    
  }
  else{
    object1.changeImage(box22_img);
    object2.destroy();
  }
